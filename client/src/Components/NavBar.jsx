  ...
  return (
    <Wrapper>
       <div className="nav-center">
          <button className="toggle-btn flex flex-col gap-[0.3rem]" type="button" onClick={toggleSidebar}>
            <span className="w-[2.5rem] h-[0.2rem] bg-[#2cb1bc] "></span>
            <span className={showSidebar? 'w-[2.5rem] h-[0.2rem] bg-[#2cb1bc] translate-x-[1rem]' : 'w-[2.5rem] h-[0.2rem] bg-[#2cb1bc]'}></span>
            <span className="w-[2.5rem] h-[0.2rem] bg-[#2cb1bc]"></span>
          </button>
          <div>
